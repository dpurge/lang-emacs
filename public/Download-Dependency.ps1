...
# korean-ipa-romaja.el
if (-not (Test-Path "${PsScriptRoot}/korean-ipa-romaja.el" -PathType leaf)) {
    Write-Host 'Download: korean-ipa-romaja.el'
    Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/poppyer9/korean-ipa-romaja/main/korean-ipa-romaja.el' -OutFile "${PsScriptRoot}/korean-ipa-romaja.el"
}